//  gcc t3.cpp -l:libgdal.so -o t -w -lstdc++
...
/* @param iSizeY	裁切行数
/************************************************************************/
void Tile(const char *pszSrcFile, const char *pszDstFile,int iStartX, int iStartY, int iSizeX, int iSizeY){
	GDALAllRegister();
